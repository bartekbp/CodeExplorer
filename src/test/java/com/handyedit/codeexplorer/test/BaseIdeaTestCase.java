...
public abstract class BaseIdeaTestCase extends LightCodeInsightTestCase {
    private File SOURCE_ROOT = new File("src/test/java");

    protected PsiClass _class;

    protected PsiClass addFile(Class aClass) throws Throwable {
        return ApplicationManager.getApplication().runWriteAction((ThrowableComputable<PsiClass, Throwable>) () -> {
    ...
    private VirtualFile addFile(VirtualFile parent, String path) throws Throwable {
        return ApplicationManager.getApplication().runWriteAction((ThrowableComputable<VirtualFile, Throwable>) () -> {
    ...
    protected void setup(Class aClass) throws Throwable {
