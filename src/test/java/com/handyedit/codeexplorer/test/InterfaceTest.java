...
public class InterfaceTest extends BaseIdeaTestCase {
    ...
    public void testInterfaceStructure() throws Throwable {
        setup(Action.class);
    ...
    public void testInterfaceUsage() throws Throwable {
        setup(Action.class);
    ...
    public void testDirectUsage() throws Throwable {
        setup(Action.class);
        PsiClass someAction = addFile(SomeAction.class);
        PsiClass actionTest = addFile(ActionTest.class);
        PsiClass childUtil = addFile(ChildUtil.class);
    ...
    public void testPackageCallChainsInterface() throws Throwable {
        setup(Action.class);
        PsiClass actionTest = addFile(ActionTest.class);
        addFile(SomeAction.class);
    ...
    public void testModuleCallChainsInterface() throws Throwable {
        doTestInterface(ParentType.MODULE);
    }

    public void testProjectCallChainsInterface() throws Throwable {
        doTestInterface(ParentType.PROJECT);
    }

    private void doTestInterface(ParentType type) throws Throwable {
        setup(Action.class);
        PsiClass actionTest = addFile(ActionTest.class);
        PsiClass childUtil = addFile(ChildUtil.class);
        addFile(SomeAction.class);
    ...
    public void testPackageCallChainsDirect() throws Throwable {
        setup(Action.class);
        PsiClass someAction = addFile(SomeAction.class);
        PsiClass actionTest = addFile(ActionTest.class);
    ...
    public void testModuleCallChainsDirect() throws Throwable {
        doTestDirect(ParentType.MODULE);
    }

    public void testProjectCallChainsDirect() throws Throwable {
        doTestDirect(ParentType.PROJECT);
    }

    private void doTestDirect(ParentType type) throws Throwable {
        setup(Action.class);
        PsiClass someAction = addFile(SomeAction.class);
        PsiClass actionTest = addFile(ActionTest.class);
        PsiClass childUtil = addFile(ChildUtil.class);
