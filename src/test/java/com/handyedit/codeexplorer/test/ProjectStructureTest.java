...
public class ProjectStructureTest extends BaseIdeaTestCase {
    ...
    public void testUsages() throws Throwable {
        setup(Child.class);
    ...
    public void testCallChainsClass() throws Throwable {
        setup(Child.class);
    ...
    public void testCallChainsPackage() throws Throwable {
        setup(Child.class);
        PsiClass parent = addFile(Parent.class);
        PsiClass childTest = addFile(ChildTest.class);
    ...
    public void testCallChainsModule() throws Throwable {
        doTest(ParentType.MODULE);
    }

    public void testCallChainsProject() throws Throwable {
        doTest(ParentType.PROJECT);
    }

    private void doTest(ParentType type) throws Throwable {
        setup(Child.class);
        PsiClass parent = addFile(Parent.class);
        PsiClass childTest = addFile(ChildTest.class);
        PsiClass childUtil = addFile(ChildUtil.class);
