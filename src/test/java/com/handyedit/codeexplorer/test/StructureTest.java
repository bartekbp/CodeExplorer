...
public class StructureTest extends BaseIdeaTestCase {
    ...
    public void testUsageRecursy() throws Throwable {
        setup();
    ...
    public void testUsageEmpty() throws Throwable {
        setup();
    ...
    public void testCallChainsTo() throws Throwable {
        setup();
    ...
    public void testManyCallChainsTo() throws Throwable {
        setup();
    ...
    public void testCycledCallChainsTo() throws Throwable {
        setup();
    ...
    public void testCallChainsToRoot() throws Throwable { // one node only
        setup();
    ...
    public void testCallsIn() throws Throwable {
        setup();
